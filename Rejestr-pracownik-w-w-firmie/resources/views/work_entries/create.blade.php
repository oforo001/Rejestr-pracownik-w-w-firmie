        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('work-entries.store') }}">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="24" name="hours_worked" id="hours_worked" value="{{ old('hours_worked') }}">
                    @error('hours_worked')
                        <div>{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="ui-actions">
                    ...
                    <button type="submit" class="ui-btn ui-btn-primary">Zapisz</button>
                </div>
            </form>
        </div>
    </div>
